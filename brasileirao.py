...
def qtos_libertadores(dados):
    numero = dados['fases']['2700']['faixas-classificacao']['classifica1']['faixa']
    lista = numero.split('-')
    return int(lista[1])
...
def ids_dos_melhor_classificados(dados,numero_de_times):
    clasi = dados['fases']['2700']['classificacao']['grupo']['Único']
    lista = []
...
def nomes_classificados_libertadores(dados):
    ...
    for i in range (len(lista)):
        nome = dados['equipes'][lista[i]]['nome-comum']
        nomes.append(nome)
    return nomes    
...
'''
def ids_dos_times_de_um_jogo(dados,id_jogo):
    time11 = dados['fases']['2700']['jogos']['id'][id_jogo]['time1']
    time22 = dados['fases']['2700']['jogos']['id'][id_jogo]['time2']
    return time11,time22 #assim a gente retorna as duas respostas em um unico return
...
def nomes_dos_times_de_um_jogo(dados,id_jogo):
   ...
   nome2 = dados['equipes'][time1]['nome-comum']
...
def data_de_um_jogo(dados,id_jogo):
    for i in dados['fases']['2700']['jogos']['id']:
        if i == id_jogo:
            return dados['fases']['2700']['jogos']['id'][i]['data']
    return 'nao encontrado'      
...
def dicionario_id_estadio_e_nro_jogos(dados):
    estadios = []
    for i in dados['fases']['2700']['jogos']['id']:
        estadios.append(dados['fases']['2700']['jogos']['id'][i]['estadio_id'])
